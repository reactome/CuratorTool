...
//		    removeAction.setEnabled(false);
                ...
                for (Iterator it = instances.iterator(); it.hasNext(); ) {
                    ...
                    if (inverseInstance.isShell()) {
                        ...
                        if (reply == JOptionPane.NO_OPTION) {
                            ...
                            PersistenceAdaptor dba = PersistenceManager.getManager().getActivePersistenceAdaptor(attributePane);
                            if (dba == null) {
                                JOptionPane.showMessageDialog(attributePane,
    ...
    public void downloadShellInstance(GKInstance shellInstance) {
        try {
            ...
            PersistenceAdaptor adaptor = PersistenceManager.getManager().getActivePersistenceAdaptor(attributePane);
            if (adaptor == null) {
