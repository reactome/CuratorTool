...
public class PathwayByPathway extends ReactionCoordinatebasedLayout {
    ...
    public PathwayByPathway(PersistenceAdaptor dba, GKInstance species, GKInstance pathway) throws Exception {
        this.dba = dba;
    ...
    public static void main(String[] args) {
        if (args.length < 6) {
            System.out.println("Usage java XXX" +
                    " dbHost dbName dbUser dbPwd dbPort use_neo4j");
